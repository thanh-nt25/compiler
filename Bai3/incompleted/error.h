...
typedef enum {
  ...
  ERR_INVALIDSYMBOL,
  ERR_INVALIDCONSTANT,//lay
  ERR_INVALIDTYPE,//lay
  ERR_INVALIDBASICTYPE,//lay
  ERR_INVALIDPARAM,//lay
  ERR_INVALIDSTATEMENT,//lay
  ERR_INVALIDARGUMENTS,//lay
  ERR_INVALIDCOMPARATOR,//lay
  ERR_INVALIDEXPRESSION,
  ERR_INVALIDTERM,//lay
  ERR_INVALIDFACTOR,//lay
